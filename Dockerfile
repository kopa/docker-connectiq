...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.vcs-url="https://github.com/kopa/docker-connectiq" \
      org.label-schema.vendor="Konrad Paumann" \
...
RUN apt-get update -y && \
    ...
    apt-get install -qqy unzip wget curl git ssh tar gzip gnupg2 ca-certificates libusb-1.0 libpng16-16 libgtk2.0-0 libwebkitgtk-1.0-0 libwebkitgtk-3.0-0 && \
    apt-get clean && \
...
# Install Eclipse IDE
ENV ECLIPSE_DOWNLOAD_URL=http://ftp.fau.de/eclipse/technology/epp/downloads/release/2021-03/R/eclipse-java-2021-03-R-linux-gtk-x86_64.tar.gz
